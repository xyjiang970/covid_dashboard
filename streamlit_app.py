...
st.text("")
st.markdown("""
The map below shows the [percentage of people ever tested for COVID-19 with a molecular test who tested positive](https://github.com/nychealth/coronavirus-data/tree/master/totals#data-by-modzctacsv) (cumulative since the start of outbreak).
""")
