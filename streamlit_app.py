...
st.markdown('While it\'s helpful to see the breakdown of general confirmed daily covid cases, it would be more helpful to see **what percentage of confirmed cases make up of the total state population** as some states hold more people than others.')
